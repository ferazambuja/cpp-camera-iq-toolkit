...
| [`spectro_result_receipt.json`](spectro_result_receipt.json) | [spectroradiometer ingest](../reports/SPECTRORADIOMETER_INGEST.md) | Binds aggregate metrics and same-record closure to committed ledger/observer hashes |
