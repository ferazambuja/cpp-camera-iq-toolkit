...
|---|---|---|
| CC ROI sidecars (target RGB) | `<camera>/Target/*_CC.txt` | ColorChecker-24 ROI RGB from the broadband Target captures; staged for Target set 1 under `private:.../<camera>/target_closure_20161121/cc24/` and used by the CC-24 closure. The 11-22 Target set 2 `_CC.txt` remain available for a repeat. |
